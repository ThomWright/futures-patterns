...
//! forwards a poll to a future underneath it. None of them explain the thing that
//! makes async work at all: a future that parks, and is woken later by *something
//! else* -- another thread, an I/O event, a timer firing.
//!
...
//! revisited, and all three break in the same two ways when it is done wrong. It is
//! worth learning once, in the simplest setting available.
